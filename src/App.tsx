...
export default function App() {
  ...
  // Bolt: ⚡ Using a Set instead of an Array for active audio nodes avoids O(n) array re-allocations on removal
          ...
          onopen: () => {
            ...
            processor.onaudioprocess = (e) => {
              ...
              for (let i = 0; i < bytes.length; i += chunkSize) {
                // Bolt: ⚡ Passing TypedArray directly avoids expensive O(n) array recreations and GC pauses caused by Array.from
