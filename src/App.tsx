...
export default function App() {
  ...
  // Using Set instead of Array for O(1) removals and avoiding array reallocation garbage collection
          ...
          onopen: () => {
            ...
            processor.onaudioprocess = (e) => {
              ...
              for (let i = 0; i < bytes.length; i += chunkSize) {
                // Casting TypedArray directly instead of using Array.from prevents massive array allocations during real-time processing
