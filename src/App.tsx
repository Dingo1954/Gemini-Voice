...
export default function App() {
  ...
  // ⚡ Bolt Performance Optimization: Using Set instead of Array for O(1) removal complexity
  // This avoids O(n) lookups and array re-allocations on hot audio playback paths.
