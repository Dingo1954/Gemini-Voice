...
export default function App() {
  ...
  // Optimization: Use a Set for active audio nodes to achieve O(1) removals and avoid
  // constant array re-allocations in the high-frequency 'onended' event handler.
        ...
        callbacks: {
          onopen: () => {
            ...
            processor.onaudioprocess = (e) => {
              ...
              // Optimization: Pass TypedArray directly to avoid expensive Array.from heap allocations
              // in this high-frequency hot path (real-time audio processing).
              let binary = '';
