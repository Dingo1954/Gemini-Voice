...
export default function App() {
  ...
  // Optimization: Using Set for O(1) addition/removal to prevent array re-allocations
          ...
          onopen: () => {
            ...
            processor.onaudioprocess = (e) => {
              ...
              for (let i = 0; i < bytes.length; i += chunkSize) {
                // Optimization: Pass TypedArray directly to avoid heap allocations from Array.from
