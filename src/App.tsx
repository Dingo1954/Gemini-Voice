...
export default function App() {
  ...
  // ⚡ Bolt Optimization: Use a Set instead of an Array for O(1) removal of audio nodes
          ...
          onopen: () => {
            ...
            processor.onaudioprocess = (e) => {
              ...
              for (let i = 0; i < bytes.length; i += chunkSize) {
                // ⚡ Bolt Optimization: Cast TypedArray directly instead of Array.from to prevent frequent heap allocations
