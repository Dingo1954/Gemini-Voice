...
export default function App() {
  ...
  const playAudio = (base64Audio: string) => {
    ...
    sourceNodesRef.current.add(source); // O(1) insertion for active audio nodes optimization
    source.onended = () => {
      sourceNodesRef.current.delete(source); // O(1) removal to prevent array re-allocations
    };
  };
