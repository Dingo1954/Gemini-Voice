...
export default function App() {
  ...
  // Bolt optimization: Use Set for O(1) audio node tracking/cleanup to avoid O(N) Array.filter re-allocations
          ...
          onopen: () => {
            ...
            processor.onaudioprocess = (e) => {
              ...
              for (let i = 0; i < bytes.length; i += chunkSize) {
                // Bolt optimization: bypass Array.from to prevent massive GC pressure on hot paths
